...
public class SuperDuperGraphTester {
	...
	public static void TESTfewestHops(String nodeFrom, String nodeTo) {
		System.out
				.println("The graph has " + graph.fewestHops(new GraphNode(nodeFrom), new GraphNode(nodeTo)) + " hops");

	}

	public static void TESTshortestPath(String nodeFrom, String nodeTo) {
		System.out.println("The graph has a shortest path of: "
				+ graph.shortestPath(new GraphNode(nodeFrom), new GraphNode(nodeTo)) + " from " + nodeFrom + " to "
				+ nodeTo);
